...
export const NavBar = () => {
    return (
        <ul className="w-full">
            <li className="hover:bg-primary hover:text-secondary rounded transition duration-200">
                <Link className="flex items-center space-x-2 px-2 py-2" to='/'>
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" stroke="#7b78ff">
