    ...
    <div className="flex flex-wrap justify-center">
      <div className="card m-2 md:m-4 lg:flex-grow">
        <div className="px-2 py-2 md:py-4">
          <div className="text-xl md:text-3xl font-bold">{questions.reduce((a, b) => a + b.likes.length + b.reading.length, 0)}</div>
      ...
      <div className="card m-2 md:m-4 lg:flex-grow">
        <div className="px-2 py-2 md:py-4">
          <div className="text-xl md:text-3xl font-bold">
            {questions.reduce((a, b) => { return (b.isSolved) ? a + b.reading.length : a }, 0)}
          </div>
