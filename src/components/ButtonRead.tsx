    ...
    if (!question.reading.includes(auth.currentUser?.uid)) {
        return (
            ...
            >
                ...
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="#78ffb9">
        ...
        return (
            <button className="flex items-center space-x-1 py-1 px-2 bg-gray-200 text-muted focus:outline-none hover:text-primary transition duration-200 rounded-full"
