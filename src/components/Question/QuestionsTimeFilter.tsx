...
export const QuestionsTimeFilter = ({
  ...
  useEffect(() => {
    if (filter.name === 'Latest') {
      ...
      const questionFilter: questionType[] = [...questions].sort(
  ...
  return (
    <ul className="flex space-x-2 sm:space-x-2">
      <li>
        <button
          className={`hover:bg-gray hover:text-blue border-b-4 ${
            filter.name === 'Latest' ? 'border-primary' : 'border-transparent'
      ...
      <li>
        <button
          className={`hover:bg-gray hover:text-blue border-b-4 ${
            filter.name === 'Week' ? 'border-primary' : 'border-transparent'
          } focus:outline-none focus:border-primary hover:border-primary
          rounded transition duration-200 px-2 py-1`}
          data-time="604800"
          onClick={handleClick}
      ...
      <li>
        <button
          className={`hover:bg-gray hover:text-blue border-b-4 ${
            filter.name === 'Month' ? 'border-primary' : 'border-transparent'
          } focus:outline-none focus:border-primary hover:border-primary
          rounded transition duration-200 px-2 py-1`}
          onClick={handleClick}
          data-time="2592000"
      ...
      <li>
        <button
          className={`hover:bg-gray hover:text-blue border-b-4 ${
            filter.name === 'Year' ? 'border-primary' : 'border-transparent'
          } focus:outline-none focus:border-primary hover:border-primary
          rounded transition duration-200 px-2 py-1`}
          onClick={handleClick}
          data-time="31536000"
      ...
      <li>
        <button
          className={`hover:bg-gray hover:text-blue border-b-4 ${
            filter.name === 'All' ? 'border-primary' : 'border-transparent'
          } focus:outline-none focus:border-primary hover:border-primary
          rounded transition duration-200 px-2 py-1`}
          onClick={handleClick}
          data-time="0"
