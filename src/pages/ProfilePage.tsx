...
export const ProfilePage = (props: any) => {
    ...
    const questions: questionType[] = useSelector((state: any) => state.questions.questions.filter((question: questionType) => question.authorId === userId));
    ...
    return (
        <div className="space-y-6 lg:w-9/12 mx-auto">
            ...
            <p className="text-center">{user.username} didn't ask anything yet !</p>}
        </div>
    )
}
