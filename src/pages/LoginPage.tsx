      ...
      <div className="flex flex-col min-w-0 break-words w-112 mb-6 shadow-lg rounded-lg bg-gray-extra-light border-0">
        <div className="rounded-t mb-0 px-6 py-6">
          <div className="text-center mb-3">
            <h6 className="text-gray text-sm font-bold">Sign in with</h6>
          </div>
          <div className="btn-wrapper text-center">
            ...
            >
              <img alt="..." className="w-5 mr-1" src="UI_icons_dark_github.svg" />
              Github
            </button>
            <button
              ...
              style={{ transition: 'all .15s ease' }}
            >
              <img alt="..." src="UI_icons_color_google.svg" className="w-5 mr-1" />
              Google
            </button>
          </div>
        ...
        <div className="flex-auto px-4 lg:px-10 py-10 pt-0">
          ...
          {error && (
            <div className="text-error bg-error rounded p-2 text-center text-sm mb-4">{error}</div>
          )}
            ...
            <div>
              <label className="inline-flex items-center cursor-pointer">
                <input
                  ...
                  style={{ transition: 'all .15s ease' }}
                />
                <span className="ml-2 text-sm font-semibold text-gray-100">Remember me</span>
              </label>
            </div>
          ...
          <div className="text-center mt-6">
            <button className="btn-white text-gray" type="button" onClick={GoToRegister}>
              New account ?
            </button>
          </div>
        </div>
